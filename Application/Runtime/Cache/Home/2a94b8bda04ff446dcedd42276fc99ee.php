		...
		<div class='container'>
			<div class='row'>
				<div class="col-md-4 col-md-offset-8">
					邮箱: 
					<a class="panel-header-text" href="#">370134974.com</a> |&nbsp; ■■■
					<a class="panel-header-text" href="javascript:window.external.addFavorite('http://www.wfstin.net','文峰视听')" >收藏本站</a>■■■
					<a class="panel-header-text" href="#" onClick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://www.wfstin.com/')">设为主页</a>
				</div>
			</div>
							...
							<div class='container'>
								<div class="navbar-header">
									...
									<a class="navbar-brand" href="#">
										<img src="/wfst/Public/images/logo2.png" width="50px">
									</a>
								</div>
...
<main class='main'>
					...
					<div id='mycarousel' class='carousel slide' data-ride='carousel'>
						...
						<div class='carousel-inner'>
							<div class="item active">
								<img src="/wfst/Public/images/w-si.jpg" class='inner-img'>
							...
							<div class="item">
								<img src="/wfst/Public/images/w_ht.jpg" class='inner-img'>
								<div class='carousel-caption'>
									<h2>HTC One mini</h2>>
							...
							<div class="item">
								<img src="/wfst/Public/images/w-ip.jpg" class='inner-img'>
								<div class='carousel-caption'>
									<h2>苹果iphone 5C</h2>>
	...
	<div class='container' >
		<!-- 欢迎来到文峰视听  -->
		<div class="row">
			<div class="col-lg-9 col-xs-9 animate-box fadeInUp animated-fast">
			...
			<div class="col-lg-3 col-xs-3 animate-box fadeInUp animated-fast">
				<div class='panel panel-bgcolor'>
					<div class='panel-heading panel-header-text'>
						<h4>请关注我们</h4>
					</div>
        ...
        <div class='row'>
        	<div class='col-md-12'>
        		<h3><center><span class='label label-danger'>最新消息</span></center></h3>
        	</div>
        </div>
        <div class='row'>
        	<div class='col-md-3'>
        		<div class='thumbnail'>
        			<img class="inner-img" src="/wfst/Public/images/tmb.jpg">
        		</div>

        		<div class='caption panel-bgcolor text-center'>
        			<a class="panel-header-text" href="">天猫双十一购物狂欢节活动筹备</a>
        		</div>
        	...
        	<div class='col-md-3'>
        		<div class='thumbnail'>
        			<img class="inner-img" src="/wfst/Public/images/lssjb.jpg">
        		</div>
        		<div class='caption panel-bgcolor text-center'>
        			<a class="panel-header-text" href="">低碳、绿色、节能</a>
        		</div>
        	</div>

        	<div class='col-md-3'>
        		<div class='thumbnail'>
        			<img class="inner-img" src="/wfst/Public/images/ktzx520.jpg">
        		</div>
        		<div class='caption panel-bgcolor text-center'>
        			<a class="panel-header-text" href="">文峰视听在线课堂</a>
        		</div>
        	</div>
        	...
        	<div class='col-md-3'>
        		...
        		<div class='caption panel-bgcolor text-center'>
        			<a class="panel-header-text" href="">连衣裙+小西装 优雅又大方</a>
        		</div>
        	</div>
        </div>
        ...
        <div class='row'>
        	<div class='col-md-12'>
        		<h3><center><span class='label label-danger'>时尚生活推荐</span></center></h3>
        	</div>
        </div>
        <div class='row'>	
        	<div class='col-md-3'>
        		<div class='panel panel-bgcolor text-center'>
        			<div class='panel-heading'>
        				<a class="panel-header-text" href="">东南亚最值得去的八大美丽海滩</a>
        			</div>
        			<div class='panel-body'>
        				<p class="text-center">
        					马尔代夫双鱼岛（olhuveli）<br>
        	...
        	<div class='col-md-3'>
        		<div class='panel panel-bgcolor text-center'>
        			<div class='panel-heading'>
        				<a class="panel-header-text" href="">名媛衣橱 五种潮流色彩的演绎</a>
        			</div>
        			<div class='panel-body'>
        				<p>
        					沉静雅致的深蓝色在2013秋冬绝对是热门的潮流色彩，明星超模们早已经开始纷纷选择深蓝色的各种服装来彰显她们秋日的时髦主张。Miranda Kerr 的露肩长裙、Angelababy 的Masha Ma 礼服、Amanda Seyfried 的雪纺透视装……全部以深蓝色为首选，学习她们是怎样将深蓝色演绎出不同风貌的吧。
        				</p>
        			</div>
        		</div>
        	</div>
        	...
        	<div class='col-md-3'>
        		<div class='panel panel-bgcolor text-center'>
        			<div class='panel-heading'>
        				<a class="panel-header-text" href="">盘点最受男人宠爱的10类女人</a>
        			</div>
        			<div class='panel-body'>
        				<p>
        				世上的女人千千万万种，男人的口味也是各不相同。但是总有那么几种女性，无论在什么地方，都是男人们趋之若鹜的对象。她可能是可爱青春的，也可能是性感魅惑的，可能是温柔体贴的，也可能是放荡不羁的。总之，她让男人不自禁地想要去宠爱，深深地为她痴狂。
        				</p>
        			</div>
        		</div>
        	</div>
        	...
        	<div class='col-md-3'>
        		<div class='panel panel-bgcolor text-center'>
        			<div class='panel-heading'>
        				<a class="panel-header-text" href="">四款浪漫设计 卧室床头柔情蜜意</a>
        			</div>
        			<div class='panel-body'>
        				<p>
        					.淡绿花卉点缀床头长物志家居欧式绿色细颈敞口刻棱玻璃花瓶 营造自然舒适卧室<br>
        ...
        <div class='row'>
        	<div class='col-md-6'>
        		<h3><center><span class='label label-danger'>公告栏</span></center></h3>
        		<div class='alert panel-bgcolor alert-dismissible'>
        	...
        	<div class='col-md-6'>
        		<h3><center><span class='label label-danger'>最近微博信息</span></center></h3>
        		<!-- <div class='row'>
        			<div class='col-xs-1'>
        				<a href="#">
