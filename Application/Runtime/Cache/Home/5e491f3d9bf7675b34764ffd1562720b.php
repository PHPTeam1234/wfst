...
<body>
		...
		<div class="col-md-12">
			...
			<div class="sep">
				<div class="container c_sep">
					<img src="/wfst/Public/images/sep_big.png">
				</div>
			</div>
		</div>
	</div>
						...
						<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner" role="listbox">
							    <div class="item active">
							      <img src="/wfst/Public/images/w-si.jpg" alt="">
			...
			<div class="row">
				<div class="col-md-3">
	                ...
	                <a class="img-title" href="#">
	                	<span>天猫双十一购物狂欢节活动筹备</span>
	                </a>
	                <img src="/wfst/Public/images/sep_small.png">
				</div>
				<div class="col-md-3">
					<div class='thumbnail'>
	                    <div class="image-hover">
				...
				<div class="col-md-3">
					<div class='thumbnail'>
	                    <div class="image-hover">
		                    <img src="/wfst/Public/images/lyqb.jpg" class="inner-img">
	                        <a href="#" class="zoom-fadeIn img-fadeIn"></a>
	                        <a href="#" class="img-fadeIn"></a>
	                        <span class="img-cover"></span>
	                    </div>
	...
	<div class="container noticeinfo">
		<div class="row">
			<div class="col-md-6">
				<img src="/wfst/Public/images/sep_medium_home.png">
				<!-- 公告 -->
				<div class="imglist">
					<span>公告</span>
				</div>
			...
			<div class="col-md-6">
				...
				<div class="news-wb">
					<div class="row">
						<div class="col-md-12">
							<!-- <img class="" src="/wfst/Public/images/xlwbicon.png">
							<p class="">载入微博，了解更多微博动态</p> -->
							<iframe width="100%" height="500" class="share_self" src="http://widget.weibo.com/weiboshow/index.php?language=&width=0&height=500&fansRow=1&ptype=1&speed=0&skin=10&isTitle=1&noborder=1&isWeibo=1&isFans=1&uid=3090040913&verifier=23a4d229&dpc=1" frameborder="0" scrolling="no"></iframe>
						</div>
					</div>
				</div>
			</div>
